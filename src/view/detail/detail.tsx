        ...
        <div className="col-md-6">
            <div className="input-group mb-3">
                <div className="input-group-prepend">
                    <span className="input-group-text">Information vendeur</span>
                </div>
            ...
            <div className="mb-3">{information.lastName} {information.firstName}</div>
            <div className="mb-3">{information.street}</div>
            <div className="mb-3">{information.complement}</div>
            <div className="mb-3">{information.zipCode} {information.city}</div>
            <div className="mb-3">{information.country}</div>
        </div>
        ...
        return <div key={`service_${i}`}>
            ...
            <div className="row">
                ...
                <div className="col-md-6">
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            <button type="button" onClick={() => facture.removeService(service)} className={`${facture.isReadOnly && "hidden"} btn btn-primary full-width attention-hover`}>Supprimer</button>
                        </div>
                    </div>
                </div>
            </div>
