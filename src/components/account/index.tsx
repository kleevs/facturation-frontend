...
export default function AccountComponentFactory({preventDefault, save}: {
    preventDefault: Tools.Mixin.preventDefault;
    save: (v: App.Account)=>void;
}): ComponentType<Components.Account.Props> { 
    return function AccountComponent({ value: account, onChange }) {
